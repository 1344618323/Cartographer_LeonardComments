...
/*(cxn)
如2d.lua设置    hit_probability = 0.55,
               miss_probability = 0.49,
               意为 p(z=1|x=1)=0.55,我们知道测量数据是一定的，则 p(z=1)=1，那么有 p(z=1|x=0)=1-p(z=1|x=1)=0.45
               笔记中的 loOccu=log(p(z=1|x=1)/p(z=1|x=0))
               同理，意为 p(z=0|x=1)=0.49,测量数据是一定的，则 p(z=0)=1，那么有 p(z=0|x=0)=1-p(z=0|x=1)=.0.51
               笔记中的 loFree=log(p(z=0|x=1)/p(z=0|x=0))
*/
